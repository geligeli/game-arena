...
/*
bazel run //game_arena/sandbox/runner:sandbox_cli -- \
  --server=localhost:50052 --target=//problem/game:risk_main \
  -- --seed=7 --games=3
*/
//
...
ABSL_FLAG(std::string, target, "",
          "Bazel target to run in the sandbox, e.g. //problem/lib:mcts "
