...
// Getting the tree ready before any step runs: staged files, host-side
// patching, and exporting a tree for a container engine to load.
//
...
// Creates the scratch dir, writes the staged files, and applies PATCH_HOST
// patches. Returns false with *status filled in.
