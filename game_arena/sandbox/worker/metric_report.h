#ifndef GAME_ARENA_GAME_ARENA_SANDBOX_WORKER_METRIC_REPORT_H
#define GAME_ARENA_GAME_ARENA_SANDBOX_WORKER_METRIC_REPORT_H
...
#endif  // GAME_ARENA_GAME_ARENA_SANDBOX_WORKER_METRIC_REPORT_H
