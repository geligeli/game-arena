#ifndef GAME_ARENA_GAME_ARENA_SANDBOX_WORKER_BOT_LAUNCH_H
#define GAME_ARENA_GAME_ARENA_SANDBOX_WORKER_BOT_LAUNCH_H
...
#endif  // GAME_ARENA_GAME_ARENA_SANDBOX_WORKER_BOT_LAUNCH_H
